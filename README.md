...
A one-time migration tool that converts an [evernote-backup](https://github.com/vzhd1701/evernote-backup) `.enex` export into Google Drive or a local folder tree. Preserves your notebook and stack hierarchy, attachments, tags, timestamps, inter-note links, and web-clip fidelity.
