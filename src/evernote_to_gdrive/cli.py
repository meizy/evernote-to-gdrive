...
def analyze(ctx, input: Path, all_reports_flag: bool, csv_dir: Path | None, include_zero: bool, bidi: bool | None):
...
def install_browsers() -> None:
    ...
    console.print("[dim]Installing Chromium headless shell...[/]")
    ...
    if rc != 0:
        console.print("[red]Chromium headless shell installation failed.[/]")
        sys.exit(rc)
    try:
